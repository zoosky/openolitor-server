  ...
  val DBInitializationScript = new Script with LazyLogging with StammdatenDBMappings {
    def execute(implicit session: DBSession): Try[Boolean] = {
      ...
      sql"""create table ${lieferplanungMapping.table}  (
        ...
        status varchar(50) not null)""".execute.apply()
      ...
      sql"""create table ${lieferungMapping.table}  (
        ...
        lieferplanung_nr int )""".execute.apply()
      ...
      sql"""create table ${lieferpositionMapping.table}  (
        ...
        preis DECIMAL(7,2), anzahl int not null)""".execute.apply()
      ...
      sql"""create table ${bestellungMapping.table}  (
        ...
        preis_total DECIMAL(7,2) not null)""".execute.apply()
      ...
      sql"""create table ${bestellpositionMapping.table}  (
        ...
        menge DECIMAL(7,2), 
        preis DECIMAL(7,2), a
        nzahl int not null)""".execute.apply()
